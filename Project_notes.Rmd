...
apparently we have several weeks in 2023 where there is no data 5659 lines. I figure I have to check those NAs and make them into the mean of that site for that years season. that way we will have the data correctly.
