...
I learned to use the line equation to predict the values for building the marginal predictors plot and the random effect plots. for [example:\\](example:\){.uri}
