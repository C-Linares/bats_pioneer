...
R keeps crashing and I suspect is the glmm_v2 package. I will start a new glmm_v3 package and we will review the bat call data base that might have a few calls missing. I will recalculate the moon intensity because it seems it's missing some dates.
...
-   I also need to check the bat bm.csv data file. I am suspecting we are missing a bunch of calls for each sepecies. Update: the error came from reporting the total number of lines for each species instead of the total number of counts for each species.
