...
-   working on glmm_v2
    ...
    -   I was mergen predictors with the data set and realize the moonlit data is missing dates. it seems like those are missing because they should be zeros. I don't know why. Now I know it was because some days the moon was zero or below the horizon so it should not be affecting.
